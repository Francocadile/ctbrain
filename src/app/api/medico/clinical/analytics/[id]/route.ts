...
export async function PATCH(req: NextRequest, ctx: { params: { id: string } }) {
  ...
  const upd: Prisma.ClinicalEntryUncheckedUpdateInput = clean({
    status: body.status === undefined ? undefined : { set: body.status as ClinicalStatus },

    // baja
    leaveStage: body.leaveStage === undefined ? undefined : { set: (body.leaveStage as LeaveStage) ?? null },
    leaveKind: body.leaveKind === undefined ? undefined : { set: (body.leaveKind as LeaveKind) ?? null },
    ...
    laterality: body.laterality === undefined ? undefined : { set: (body.laterality as Laterality) ?? null },
    mechanism: body.mechanism === undefined ? undefined : { set: (body.mechanism as Mechanism) ?? null },
    severity: body.severity === undefined ? undefined : { set: (body.severity as Severity) ?? null },

    // enfermedad
    illSystem: body.illSystem === undefined ? undefined : { set: (body.illSystem as SystemAffected) ?? null },
    illSymptoms: body.illSymptoms === undefined ? undefined : { set: body.illSymptoms ?? null },
    illContagious: body.illContagious === undefined ? undefined : { set: body.illContagious ?? null },
    illIsolationDays: body.illIsolationDays === undefined ? undefined : { set: body.illIsolationDays ?? null },
    illAptitude: body.illAptitude === undefined ? undefined : { set: (body.illAptitude as IllAptitude) ?? null },
    ...
    expectedReturnManual: expectedReturnManual === undefined ? undefined : { set: expectedReturnManual },
    ...
    noChangeOfDirection: body.noChangeOfDirection === undefined ? undefined : { set: !!body.noChangeOfDirection },
    ...
    protocolObjectives: body.protocolObjectives === undefined ? undefined : { set: body.protocolObjectives ?? null },
    protocolTasks: body.protocolTasks === undefined ? undefined : { set: body.protocolTasks ?? null },
    protocolControls: body.protocolControls === undefined ? undefined : { set: body.protocolControls ?? null },
    protocolCriteria: body.protocolCriteria === undefined ? undefined : { set: body.protocolCriteria ?? null },
  });
  ...
  try {
    ...
    console.error("PATCH /api/medico/clinical/[id] error:", e);
...
export async function DELETE(req: NextRequest, ctx: { params: { id: string } }) {
  ...
  try {
    ...
    console.error("DELETE /api/medico/clinical/[id] error:", e);
