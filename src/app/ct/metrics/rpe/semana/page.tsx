  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="rounded-xl border bg-white p-3 text-xs text-gray-600 flex flex-wrap gap-3">
        <div><b>AU total (promedio/jugador):</b> {Math.round(summary.totalAU)} AU <span className="text-gray-400">/</span> {Math.round(summary.avgAU)} AU</div>
        <div className="ml-auto text-gray-500">Jugadores: <b>{summary.players}</b></div>
      </div>
      ...
      <section className="rounded-2xl border bg-white overflow-hidden">
        <div className="bg-gray-50 px-3 py-2 text-[12px] font-semibold uppercase">AU por día y métricas</div>
        {loading ? (
