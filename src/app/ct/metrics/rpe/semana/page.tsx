    ...
    <div className="p-4 space-y-4">
      ...
      <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          <h1 className="text-lg font-bold">
            RPE — Semana (CT){" "}
            <HelpTip text="Vista semanal de carga interna. Cada AU es RPE×min. Calcula ACWR, Monotonía y Strain." />
          </h1>
          <p className="text-xs text-gray-500">
            Semana: <b>{toYMD(monday)}</b> a <b>{toYMD(addDays(monday,6))}</b> • {filtered.length} jugador(es)
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button onClick={exportCSV} className="rounded-lg bg-black text-white px-3 py-1.5 text-sm hover:opacity-90">
            Exportar CSV{" "}
            <HelpTip text="Descarga la tabla con AU por día y métricas (ACWR, Monotonía, Strain)." />
          </button>
        </div>
      </header>
      ...
      <div className="rounded-xl border bg-white p-3 text-xs text-gray-600 flex flex-wrap gap-3">
        <div>
          ...
          {Math.round(summary.totalAU)} AU <span className="text-gray-400">/</span>{" "}
          {Math.round(summary.avgAU)} AU
        </div>
              ...
              <thead>
                <tr className="border-b bg-gray-50">
                  ...
                  <th className="text-right px-3 py-2">
                    AU total{" "}
                    <HelpTip text="Suma de AU (RPE×min) de la semana seleccionada por jugador." />
                  </th>
                  <th className="text-right px-3 py-2">
                    Agudo (7d){" "}
                    <HelpTip text="Carga aguda: AU acumulada en los últimos 7 días. En una semana completa coincide con AU total." />
                  </th>
                  <th className="text-right px-3 py-2">
                    Crónico (28d){" "}
                    <HelpTip text="Carga crónica: promedio diario de AU en 28 días × 7. Representa 'tu semana típica' reciente." />
                  </th>
                  <th className="text-right px-3 py-2">
                    ACWR{" "}
                    <HelpTip text="Relación Agudo/Crónico. Objetivo 0.8–1.3; 1.3–1.5 atención; >1.5 o <0.8 riesgo." />
                  </th>
                  <th className="text-right px-3 py-2">
                    Monotonía{" "}
                    <HelpTip text="Media diaria de AU / desvío estándar diario. Alto = poca variabilidad de carga." />
                  </th>
                  <th className="text-right px-3 py-2">
                    Strain{" "}
                    <HelpTip text="AU total × Monotonía. Estrés de carga semanal; sube con volumen alto y poca variación." />
                  </th>
                </tr>
              </thead>
              <tbody>
