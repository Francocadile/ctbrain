// src/app/ct/sesiones/[ymd]/[turn]/page.tsx
"use client";
...
export default function SessionTurnoPage() {
  ...
  const focus = qs.get("focus") || ""; // PRE ENTREN0 | FÍSICO | TÉCNICO–TÁCTICO
  ...
  // Scroll/Focus al bloque solicitado
  useEffect(() => {
        ...
        {blocks.map(({ row, text, id }) => (
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              {id ? (
                <a
                  href={`/ct/sesiones/${ymd}/${turn}?focus=${encodeURIComponent(row)}`}
