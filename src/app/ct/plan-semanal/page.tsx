...
const MICRO_CHOICES: Array<{
  ...
  { value: "MD+1", label: "MD+1 , colorClass: "bg-blue-50" },
  { value: "MD+2", label: "MD+2 , colorClass: "bg-yellow-50" },
  { value: "MD-4", label: "MD-4 , colorClass: "bg-red-50" },
  { value: "MD-3", label: "MD-3 , colorClass: "bg-orange-50" },
  { value: "MD-2", label: "MD-2 , colorClass: "bg-green-50" },
  { value: "MD-1", label: "MD-1 , colorClass: "bg-gray-50" },
