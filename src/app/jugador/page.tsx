  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <Link href="/jugador/wellness" className="rounded-2xl border bg-white p-4 hover:bg-gray-50">
        ...
        <Link href="/jugador/rpe" className="rounded-2xl border bg-white p-4 hover:bg-gray-50">
